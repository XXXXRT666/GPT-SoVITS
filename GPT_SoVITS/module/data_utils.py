...
from GPT_SoVITS.utils import load_filepaths_and_text, load_wav_to_torch
...
class TextAudioSpeakerLoaderV3(torch.utils.data.Dataset):
    ...
    def get_audio(self, filename):
        ...
        spec1 = spectrogram_torch(
            audio_norm24, self.filter_length_mel, self.sampling_rate_mel, self.hop_length_mel, self.win_length_mel, center=False
        )
