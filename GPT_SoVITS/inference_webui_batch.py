...
from config import change_choices, get_dtype, get_weights_names, infer_device as default_device, pretrained_sovits_name
...
tts_pipeline = TTS(tts_config, args.backends, args.quantization, cache_size=1)
